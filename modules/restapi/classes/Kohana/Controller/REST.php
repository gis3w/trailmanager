...
abstract class Kohana_Controller_REST extends Controller {
	...
	(
		...
		HTTP_Request::PUT    => 'create',
		HTTP_Request::POST   => 'update',
	...
	public function before()
	{
		...
		$this->_REST_Method = Arr::get($_SERVER, 'HTTP_X_HTTP_METHOD_OVERRIDE', $this->request->method());

		if ( ! isset($this->_action_map[$this->_REST_Method]))
		{
			$this->request->action('invalid');
		}
		else
		{
			$this->request->action($this->_action_map[$this->_REST_Method]);
