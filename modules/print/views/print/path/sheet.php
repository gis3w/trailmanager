        ...
        <div>
            <div class="characteristics box">
                ...
                <div class="body-box">
                    ...
                    <div class="item-image"><img src="<?php echo $tmp_dir.'/public/img/lunghezza.png' ?>" /><div><?php echo __('Length') ?>: <?php echo $path->l ?></div></div>
                    <div class="item-image"><img src="<?php echo $tmp_dir.'/public/img/dislivello.png' ?>" /><div><?php echo __('Altitude gap') ?>: <?php echo $path->diff_q ?></div></div>
