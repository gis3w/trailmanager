...
class Email_Passagestate_INACCETTAZIONERIFIUTATA {
    ...
    public function buildBodyMail()
    {
        ...
        $bodyMail = View::factory('email/passagestate/inaccettazionerifiutata');
        $bodyMail->highliting = $this->highliting; 
        $this->_bodyMail =$bodyMail; 
        $this->_subject = $config['pre_email_subject'].__('Highlighting reject'); //Segnalazione correttamente rigistrata sul portale
